...
class Network:
	...
	def build_pp_network(
		...
		sgen_ids = self.create_elements(df_sgen_pp, pp.create_gen, pp_network)
		...
		switches_ids = self.create_elements(df_switch_pp, pp.create_switch, pp_network) # TODO VARIABLE UNUSED?
