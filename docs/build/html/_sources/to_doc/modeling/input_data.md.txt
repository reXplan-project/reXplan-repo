...
as `basic_example.ipynb`. If a new project is created, the .ipynb file should be kept in this directory. The input data, as explained in the basic example, is located at the following directory:

```
-/reXplan/jupyter_notebooks/file/input/[simulationName]
